                    ...
                    <div class="card-body">
                        ...
                        if (isset($_POST['import_csv'])) {
                            ...
                            if (isset($_FILES['csv_file']) && $_FILES['csv_file']['error'] === UPLOAD_ERR_OK) {
                                ...
                                if ($fileExtension === 'csv') {
                                    ...
                                    echo "<div class='alert alert-warning'>Molimo otpremite fajl sa .csv ekstenzijom.</div>";
                                }
                            } else {
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="file" name="csv_file" id="csv_file" class="form-control-file" required accept=".csv">
                            </div>
